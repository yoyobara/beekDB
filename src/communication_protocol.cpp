...
{
	spdlog::debug("sending message (command: '{}', content: '{}', content_size: {} bytes)", message.command, message.content, message.content.size());
...
comms::message_t comms::recv_message(const Socket &s)
{
	...
	spdlog::debug("recieved message (command: '{}', content: '{}', content_size: {} bytes)", msg.command, msg.content, msg.content.size());
